      ...
      <section className="px-4 py-20 md:px-8 lg:py-22.5 2xl:px-0">
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          >
            ...
            <p className="mx-auto lg:w-11/12">
              Pump 360 empowers businesses worldwide with comprehensive ERP, POS, and accounting solutions, ensuring streamlined operations and business growth.
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Businesses Using Pump 360</p>
            </motion.div>
            <motion.div
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Transactions Processed</p>
            </motion.div>
            <motion.div
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Uptime Guarantee</p>
            </motion.div>
          </div>
        </div>
      </section>
