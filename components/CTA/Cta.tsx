          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Boost Your Business with Pump 360 Today
              </h2>
              <p>
              Pum360 is an all-in-one fuel station management software that helps businesses track sales, monitor inventory, manage credit customers, and streamline finances all in real-time.
              </p>
            </motion.div>
            <motion.div
              variants={{
